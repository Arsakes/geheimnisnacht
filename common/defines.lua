...
-- Title Grant Decadence Reduction (Multiplied with current decadence)
	...
	DE_JURE_ASSIMILATION_YEARS = 0,			-- Duchies a under the de facto control of another kingdom will change de jure liege after this many years
	EMPIRE_DE_JURE_ASSIMILATION_YEARS = 0,	-- Kingdoms under the de facto control of another empire will change de jure liege after this many years
...
NMilitary = {
	...
	PIKEMEN_MORALE = 6,
	PIKEMEN_MAINTENANCE = 10,
	PIKEMEN_PHASE_SKIRMISH_ATTACK = 8,
	PIKEMEN_PHASE_MELEE_ATTACK = 4,
	PIKEMEN_PHASE_PURSUE_ATTACK = 1,
	PIKEMEN_PHASE_SKIRMISH_DEFENSE = 15,
	PIKEMEN_PHASE_MELEE_DEFENSE = 7,
